...
async function test(extraBody) {
  ...
  try {
    ...
    console.log(`Test with ${JSON.stringify(extraBody)}:`);
...
async function run() {
  ...
  await test({ user_location: [52.2215372, 6.8936619] });
  await test({ address_id: ADDRESS_ID, user_location: [52.2215372, 6.8936619] });
}
run();
