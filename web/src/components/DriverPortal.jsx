    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans flex flex-col items-center justify-between pb-8">
      ...
      {scannedNotice && (
        <div className="fixed top-4 left-1/2 transform -translate-x-1/2 z-[200] w-full max-w-sm px-4 animate-bounce-in">
          <div className={`border rounded-3xl p-5 shadow-2xl flex items-center space-x-3 backdrop-blur-md ${scannedNotice.type === 'success' ? 'bg-emerald-950/90 border-emerald-500/50 text-emerald-200' :
            ...
            {activeOrder ? (
              <div className="bg-slate-900 border border-slate-800 rounded-3xl p-5 space-y-4 shadow-xl animate-fade-in">
                <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                  ...
                  <div className={`px-2.5 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider ${activeOrder.status === 'completed'
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-2 bg-slate-900 p-1.5 rounded-xl border border-slate-800">
                  <button
                    ...
                    className={`py-2 text-center rounded-lg text-xs font-bold transition-all ${activeSubTab === 'my_tasks'
                  ...
                  <button
                    ...
                    className={`py-2 text-center rounded-lg text-xs font-bold transition-all relative ${activeSubTab === 'offers'
                        ? 'bg-slate-800 text-white border border-slate-700'
                        : 'text-slate-400 hover:text-white'
                      }`}
                  >
